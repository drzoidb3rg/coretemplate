...
$ImageName = "username/docsupply"

# Calculate the name of the container created by the compose file
$ContainerName = "${ProjectName}_docsupply"
...
function PublishProject () {
    ...
    try {
        ...
        # Publish the project
		Write-Verbose "PUBLISH COMMAND: dotnet publish -f $Framework -r $RuntimeID -c $Environment -o $pubPath $ProjectFolder"
